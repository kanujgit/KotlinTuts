...
class UiThreadDemoFragment : BaseFragment() {
    ...
    private fun executeBenchmark() {
        ...
        // added thread for performing concurrent task so UI will free to execute their task
        Thread {
            ...
            //added handler for performing ui task in main thread
            Handler(Looper.getMainLooper()).post {
                logThreadInfo("handler thread info")
