...
class Exercise1FragmentMySolution : BaseFragment() {

    override val screenTitle get() = ScreenReachableFromHome.EXERCISE_1_SOLUTION.description
    ...
    companion object {
        fun newInstance(): Fragment {
            return Exercise1FragmentMySolution()
        }
    }
}