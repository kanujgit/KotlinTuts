...
class Exercise9SolutionFragment : BaseFragment() {

    private val coroutineScope = CoroutineScope(Dispatchers.Main.immediate)

    override val screenTitle get() = ScreenReachableFromHome.EXERCISE_9.description

    private lateinit var fetchAndCacheUsersUseCase: FetchAndCacheUsersUseCaseSolutionExercise9
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fetchAndCacheUsersUseCase = compositionRoot.fetchAndCacheUserUseCaseSolutionExercise9
    }
    ...
    companion object {
        fun newInstance(): Fragment {
            return Exercise9SolutionFragment()
        }
    }
}