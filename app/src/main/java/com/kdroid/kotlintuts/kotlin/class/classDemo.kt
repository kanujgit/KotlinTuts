package com.kdroid.kotlintuts.kotlin.`class`

class classDemo private constructor(val lan: Int) {
...
class Child : Parent {
    ...
    constructor(
        arg: Int,
        arg2: Unit = println("Child secondary constructor default argument")
    ) : this() {
